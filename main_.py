...
class Tester(object):
    ...
    def test(self, dataset, p_LMs, d_LMs):
        ...
        for data in dataset:
            i = i + 1
            molecule_word, molecule_atom, molecule_adj, protein, sequence, smile, label, _ = data
            molecule_words.append(molecule_word)
            molecule_atoms.append(molecule_atom)
            molecule_adjs.append(molecule_adj)
            proteins.append(protein)
...
if __name__ == "__main__":
    ...
    """Output files."""
    file_AUCs = '/t-yzh/stu-3031/MMDG_Data/output/result/AUCs--' + setting + '.txt'
    file_model = '/t-yzh/stu-3031/MMDG_Data/output/model/' + setting
